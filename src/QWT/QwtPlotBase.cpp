...
QwtPlotBase::QwtPlotBase(QWidget *parent, QString className):QwtPlot(parent),MsigmaBase(className)
{
    ...
    picker->setMousePattern( QwtEventPattern::MouseSelect2, Qt::RightButton, Qt::ControlModifier );
    picker->setMousePattern( QwtEventPattern::MouseSelect3, Qt::LeftButton );
//    picker->setMousePattern(QwtEventPattern::MouseSelect3, Qt::MidButton );
//    picker->setMousePattern(QwtEventPattern::MouseSelect6, Qt::MidButton, Qt::ControlModifier );
//    picker->setMousePattern(QwtEventPattern::MouseSelect2, Qt::MidButton, Qt::ShiftModifier );
